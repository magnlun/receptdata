...
public class RecipeWindow extends JFrame implements
	...
	public RecipeWindow(String[][] innehall, String recept){
		this(innehall, recept, true);
	}
	public RecipeWindow(String[][] innehall, String recept, Boolean visible) {
