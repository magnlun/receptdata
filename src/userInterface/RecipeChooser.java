...
public class RecipeChooser extends JFrame implements DocumentListener, ActionListener{
	...
	public RecipeChooser(ReceptMottagare förälder, Boolean dummy){
		this(förälder);
	...
	public RecipeChooser(ReceptMottagare förälder){
