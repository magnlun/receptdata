...
public class Inköpslista extends JFrame implements Ruta, ActionListener, DocumentListener, ReceptMottagare{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == klar){
			...
			ProcessRecept.takeData(recept, ingredienserText);
			button.changeList(new Inköpslista());
		}
		else{
			ReceptVäljare temp = new ReceptVäljare(this);
